...
export const nftsTable = pgTable("nfts", {
  ...
  nftType: text("nft_type").notNull(), // 'golden_wheat', 'diamond_chicken', 'royal_cow', etc.
...
export const nftTradeOffersTable = pgTable("nft_trade_offers", {
  ...
  targetTelegramId: text("target_telegram_id"), // null = public offer
  wantedNftType: text("wanted_nft_type"), // null = open for any offer
