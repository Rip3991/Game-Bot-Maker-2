...
export default function InvitePage() {
  ...
  const handleShare = () => {
    const text = encodeURIComponent(`Sarı'nın Çiftliği'ni oyna ve 25 Coin kazan! 🌾🪙 Sen davet edersen 50 Coin kazanırsın!`);
